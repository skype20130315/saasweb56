	...
	$(function(){
		$('#goodsdetail').datagrid({
			...
			columns:[[
				...
				{field:'GDBARCODE',title:'销售条码',width:140,align:'left',sortable:true},
			    {field:'GDNAME',title:'商品名称',width:280,align:'left',sortable:true},
			    {field:'GDPPNAME',title:'品牌名称',width:85,align:'left',sortable:true},		    
			    {field:'GDSPEC',title:'规格',width:45,align:'left',sortable:true},
			    ...
			    {field:'GDCATID',title:'类别编码',width:60,align:'left',sortable:true},
			    {field:'GDCATNAME',title:'类别名称',width:60,align:'left',sortable:true},				    	
				...
				{field:'GSSUPID',title:'供应商编码',width:80,align:'left',sortable:true},	
				{field:'SUPNAME',title:'供应商名称',width:152,align:'left',sortable:true}
				<%}%>
			]],
			toolbar:[{
				text:'导出Excel',
					...
					data :obj2str(
						{		
							...
							list:[{
								exportExcel : true,
								<%if ("L".equalsIgnoreCase(currUser.getSutype().toString())) {%>
								enTitle: ['GDID','GDBARCODE','GDNAME','GDPPNAME','GDSPEC','GDUNIT','GDTAX','GDAREA','GDCATID','GDCATNAME','TEMP1','TEMP2','GSSUPID','SUPNAME'],
								cnTitle: ['商品编码','商品条码','商品名称','品牌名称','规格','单位','税率','产地','类别编码','类别名称','进价','售价','供应商编码','供应商名称'],
								<%} else {%>
